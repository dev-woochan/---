...
$commentSql = "SELECT comment.id, comment.create_time, content, parentPostId, parentCommentId, orderNumber, depth, user.name, deleted, replyOrder 
FROM comment
...
//조회수 
$watchSql = "UPDATE koPost SET watchCnt = watchCnt + 1 WHERE id = ($post_num) ";
                ...
                <div class="header_top">
                    ...
                    <div>
                        ...
                        if ($result_array["name"] == $user_name) {
                            echo "<form action='http://192.168.101.129/risingproject/board_koreaStock/koPost_update.php' method='POST'>";
                            ...
                            echo "</form>";
                            echo "<form action='http://192.168.101.129/risingproject/board_koreaStock/koPost_delete.php' method= 'POST'onsubmit='return confirm(\"정말로 삭제하시겠습니까??\");'>";
                            echo "<input type='hidden' id='post_id' name='post_id' value= $post_num>";
