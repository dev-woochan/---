...
WHERE koPost.id = ($post_id) ";
    ...
    <main>
        ...
        <form action="koPost_update_process.php" class="write_form" method="post" id="write_form">
            <div class="form_wrap">
                ...
                <div class="write_stock">
                    <label>종목명</label><input type="text" class="write_textarea" name="stockName" id="stockInput"
                        value="<?php echo $result_array['stockName'] ?>">
                </div>
                <div class="write_stock">
                    <label>포스팅가격</label>
                    <span><?php echo $result_array['postPrice'] . "원" ?></span>
                    <label>목표일</label>
                    <input type="text" name="goalDate" id="datepicker" class="datepicker"
