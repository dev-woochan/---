...
$stmt = $mysqli->prepare("INSERT INTO usPost (create_time, title ,user_id, symbol, content, watchCnt, likeCnt, riseSelect, goalDate, postPrice) 
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
$stmt->bind_param("ssisssissi", $create_time, $title ,$user_id , $symbol, $content, $watchCnt, $likeCnt, $riseSelect, $goalDate, $postPrice);
