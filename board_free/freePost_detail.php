...
// 게시글 불러오기 
$sql = "SELECT freePost.create_time,title, user.name, content, watchCnt, likeCnt
FROM freePost  
JOIN user ON freePost.user_id = user.id
WHERE freePost.id = ($post_num) ";
...
$commentSql = "SELECT freeComment.id, freeComment.create_time, content, parentPostId, parentCommentId, orderNumber, depth, user.name, deleted, replyOrder 
FROM freeComment
...
//조회수 
$watchSql = "UPDATE freePost SET watchCnt = watchCnt + 1 WHERE id = ($post_num) ";
        ...
        <div class="articleContentBox">
            <div class="article_header">
                <div class="header_top">
                    <a href="http://192.168.101.129/risingproject/board_freeStock.php" class="link_board">자유 게시판</a>
                    <div>
                        <?php
                        if ($result_array["name"] == $user_name) {
                            echo "<form action='http://192.168.101.129/risingproject/board_free/freePost_update.php' method='POST'>";
                            ...
                            echo "</form>";
                            echo "<form action='http://192.168.101.129/risingproject/board_free/freePost_delete.php' method='POST' onsubmit='return confirm(\"정말로 삭제하시겠습니까??\");'>";
                            echo "<input type='hidden' id='post_id' name='post_id' value='$post_num'>";
                    ...
                    while ($comment_row = mysqli_fetch_array($commentResult)) {
                        ...
                        <ul class="reply_container">
                            ...
                            FROM 
                                ...
                                LEFT JOIN freeComment AS parent ON fc.parentCommentId = parent.id
